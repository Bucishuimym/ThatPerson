...
```python
from vault_api import create_api

# 1. 创建API实例
api = create_api(r"g:\XXFS\groWiki")
...
```json
{
  ...
  "category": "resource",         // PARA分类: inbox/project/area/resource/archive/card/diary/template/asset/plugin
  "tag": "提示词",                // 标签过滤
...
- [知识库分类指引.md](../../知识库分类指引.md) - PARA 分类规则
- [仓库结构.md](../../仓库结构.md) - 当前仓库结构
...
4. **多仓库支持**：扩展 `VaultReader` 支持多路径并行扫描
